...
Both are auto-generated by `scripts/sync-platforms.sh`. Commands are copied verbatim from `commands/*.md` — frontmatter (`description`, `argument-hint`) is preserved in both `.opencode/commands/` and `.agent/workflows/`.
